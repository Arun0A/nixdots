...
let
  ...
  "purify-nix-all" = "sudo nix-env --delete-generations old --profile /nix/var/nix/profiles/system \
  ...
  "purify-nix-nuclear" = "sudo nix-env --delete-generations old --profile /nix/var/nix/profiles/system \
    && nix-env --delete-generations old \
    && home-manager expire-generations \"-0 days\" \
